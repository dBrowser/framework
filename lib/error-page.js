  ...
  if (typeof e === 'object') {
    ...
    switch (e.errorCode) {
      ...
      case 504:
        ...
        errorDescription = `dBrowser will keep searching. Wait a few moments and try again.`
        moreHelp = `
          <p>
            Troubleshooting:
          </p>
          ...
          <ul>
            <li>Your firewall may be blocking peer-to-peer traffic.<br /><a class="link" href="http://docs.dbrowser.io/using-beaker/troubleshooting.html" target="_blank">How to configure your firewall.</a></li>
            <li>There may not be any peers hosting this ${e.resource} right now.<br /><a class="link" href="bench://swarm-debugger/${e.validatedURL.slice('dweb://'.length)}">Open the network debugger</a>.</li>
            <li>If you think this is a bug, copy the <a class="link" href="bench://debug-log/" target="_blank">debug log</a> and <a class="link" href="https://github.com/dbrowser/dbrowser/issues" target="_blank">file an issue</a>.</li>
          </ul>
        `
        break
    }
  ...
  return `
    <html>
      ...
      <body>
        ...
        <link rel="stylesheet" href="bench://assets/font-awesome.css">
