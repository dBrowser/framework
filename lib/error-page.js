    ...
    switch (e.errorCode) {
      ...
      case 504:
        ...
        moreHelp = `
          ...
          <ul>
            <li>Your firewall may be blocking peer-to-peer traffic.<br /><a class="link" href="http://docs.dbrowser.io/troubleshooting.html" target="_blank">How to configure your firewall.</a></li>
            <li>There may not be any peers hosting this ${e.resource} right now.<br /><a class="link" href="bench://flock-debugger/${e.validatedURL.slice('dweb://'.length)}">Open the network debugger</a>.</li>
